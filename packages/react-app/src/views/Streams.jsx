...
export default function Streams({ withdrawStreamEvents, openStreamEvents, contractName, signaturesRequired, address, nonce, userProvider, mainnetProvider, localProvider, yourLocalBalance, price, admin, tx, readContracts, writeContracts, blockExplorer }) {
